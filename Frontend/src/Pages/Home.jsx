...
import CategorySlider from "./include/CategorySlider";
        ...
        const fetchProducts = async () => {
            try {
                ...
                const latestProducts = allProducts
                    ...
                    .slice(0, 8); // Get latest 8 products
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="title-area-between">
                                <h2 className="title-left mb--10">Featured Products</h2>
                            </div>
                        </div>
                    </div>
                    <div className="row">
                            ...
                            <div className="cover-card-main-over">
                                <div className="row g-4">
                                    ...
                                    {filteredProducts.length > 0 ?
                                        ...
                                        )) : <p className="text-danger mx-auto d-flex justify-content-center align-items-center">No Featured products available.</p>
                                    }
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div className="col-xl-8 col-lg-12">
                                        <div className="row">
                                            {discountProducts.length > 0 ?
                                                ...
                                                )) : <p className="text-danger mx-auto d-flex justify-content-center align-items-center">No Discount Available.</p>}
                        ...
                        <div className="col-lg-12">
                            <div className="cover-card-main-over">
                                ...
                                {topProducts.length > 0 ?
                                        ...
                                        )) : <p className="text-danger mx-auto d-flex justify-content-center align-items-center">No top products available.</p>
                                    }
                                </div>
                            </div>
                        </div>
